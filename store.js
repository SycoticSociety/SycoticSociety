...
function purchaseClicked() {
    alert('Approve MetaMask request to complete purchase')
...
async function requestApproval() {
  ...
  const tx = await contract.methods.approve("0xE7F3c7C6611357313B5C2734341fe9cBad1D9f59",tx.tokenAmount).send({
    from: userAddress
  });
